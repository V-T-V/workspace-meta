...
datas = [('web', 'web'), ('scripts/musetalk_render.py', 'scripts'), ('scripts/cosyvoice_tts.py', 'scripts'), ('assets', 'assets'), ('config.example.yaml', '.'), ('config.dev.yaml', '.')]
binaries = []
